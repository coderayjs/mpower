    ...
    <div className="px-4 py-8 mx-auto max-w-6xl md:px-24 lg:px-8 lg:py-8">
      <div className="max-w-xl mb-8 md:mx-auto sm:text-center lg:max-w-2xl md:mb-8">
        ...
        <p className="text-base text-black md:text-lg">
          The easy way for your employees to buy company swag print on demand
          with no minimums.
        </p>
      </div>

      <img src="https://store-media.mpowerpromo.com/5e4ef2d67141a025da688296/pages/649dcb902e4c3b0e56729cd0/PromoForceFinal-1688079469835.png" />
